...
text(0.6,0,expression(2*u[b]),adj=c(1,0),cex=1.5)
text(0.1,0.2,expression(2*l[b]),adj=c(1,0),cex=1.5)
text(0.12,0.4,expression(u[t]+v[t]==2*l[b]),cex=1.5,srt=-45)
text(0.65,0.22,expression(u[t]+v[t]==2*u[b]),cex=1.5,srt=-45)
...
text(0.2,0.01,expression(2*b),adj=c(1,0),cex=1.5)
arrows(x0=1,y0=1,x1=1,y1=0.6,code=3,lwd=1.5,length=0.2)
text(1,0.8,expression(2*b),adj=c(1,0),cex=1.5)
...
text(0.82,1.12,expression(u[t]+v[t]==2),cex=1.5,srt=-18,xpd=NA)
