...
<!--***DAN: need to replace tail dependence with tail associations throughout. This has largely been done
now by Shyamolina, but still we should-->
...
the *normalized rank plot* for $y_t$ and $x_t$. For instance, the normalized rank plots for
...
*tail association*, i.e., associations between the more extreme 
...
association between the "coldness" of the surface water (measured, for instance,
...
tail association (or anything else about associations between variables) for independent
