...
<!--***DAN: make sure to use language like "we begin to adress some of 
these questions", because we have not really looked deeply into whether
copula structure influences community variability, or into whether
copula structure influences interactions between species. We are just
looking at the precursor qs of whether copula structure is there and 
...
One possible causal mechanism, similar to some of the mechanisms 
...
is an important
correlate of phytoplankton abundance in our data [e.g., @sheppard2017; @sheppard2019]:
cold water is associated with mor phytoplankton, likely because upwelling and 
...
mederate winters produce, on average, no earlier first flights than
do warm winters, then that corresponds to a right-tail-dependent 
positive association between the "coldness" of winter (measured, for instance,
by how many degrees colder a given winter is than the average winter)
and first-flight date. If such tail dependence is strong and consistent
across the aphid species for which we have data, it should
produce positive associations with right-tail dependence between 
first-flight time series for different species. Likewise, 
in locations for which the winter coldness-first flight association
is shows less right-tail dependence, one should 



Final para of the intro
