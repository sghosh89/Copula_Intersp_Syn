...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=8cm]{./Results/pedagog_fig.pdf}
...
***Shya: see the plots saved in Results folder named "pedagog_fig.pdf"

***DAN: Looks good, but can you add the Pearson and Spearman correlations to A and B (only), please,
as in the BIVAN figure? 
Also, I put some notes on your desk indicating how to make panels e and f.
See above the new caption for the new Fig. 1, in case it helps to understand how we are using this.
-->
...
Q1 from the Introduction, as follows. First, we counted the number, 
