...
very different patterns of association [@Ghosh_copula; @ghosh2020tail]. Correlations
...
tail association. <!--DAN CHANGED:-->We introduce copulas instead of proceding directly to 
...
consitute annual abundances of all species of plant in an area. In that dataset,
...
Plankton data are available from the Dryad Digital Repository https://doi.org/10.5061/dryad.rq3jc84 [@Sheppard2019data]. 
Full code for the analyses are at \url{https://github.com/sghosh89/Copula_Intersp_Syn}.
