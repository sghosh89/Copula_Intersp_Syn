...
We also counted the number, $N_R^n$, or right-tail dominant pairs, for which 
...
presentational changes, please make them.

***Shya : I made changes in figs. upto Fig. 1-3, S1-S4 and notations in text upto here.-->
...
*Ceratium* data as follows.
...


We answered Q2 for the aphid data as follows.
...
