...
<!--***DAN: Some text that I cut from the Results but might be good for the Discussion:
Major asymmetric tail-dependence 
...
<!--***DAN: text that may be useful in the Discussion when I revisit the fact that 
results for the A_C^n A_D^n correlation were significant for plankton but not aphids:
Since aphids were 20 different sp. which 
