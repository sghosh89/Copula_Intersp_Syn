...
Monitoring tail dependence between species could reveal interesting information about 
an ecosystem. If most of its member species in a 
community go synchronously rare or synchronously abundant,
then their synchronous behavior results in asymmetric tail-dependence for the overall community.
Net productivity for such ecosystem could be constrained by some limiting factors (Leibig's law)
