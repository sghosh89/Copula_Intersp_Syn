...
$A_S^{n+} = \sum\limits_{i=1}^s\sum\limits_{j=1}^s C^n_{L-U}(i, j)$ where $C^n_{L-U}(i, j) >0$ 
and $A_S^{n-} = \sum\limits_{i=1}^s\sum\limits_{j=1}^s C^n_{L-U}(i, j)$ where $C^n_{L-U}(i, j) <0$, 
