...
that seem likely to be ecologically important [@Ghosh_copula].
...
<!--***DAN: do a search for copula. Probably we should get away from copula
through the paper, talking only about tail associations, and then come back
to it in the Discussion-->
We here begin exploring whether copula structure, specifically tail associations, may be important for 
...
structure and asymmetric tail associations for such central ecological topics as synchrony and 
...
<!-- MUST to ADD for Journal of Animal Ecology --
...
Acquisition of funding, provision of facilities, or supervising the research group of authors without additional contribution are not usually sufficient justifications for authorship. The statement should include an explanation of the contribution of each author.

We suggest the following format for the Author contributions statement:
