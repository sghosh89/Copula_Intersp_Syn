...
<!--***DAN: Lawrence was confused here by my (arbitrary) use of right tails, and 
thought I was contrastoing with the opposite left-tail situation, when in fact
I was just contrasting with a situation without tail association. Basically the 
idea is even if you have pretty high correlation, if there is tail association,
then you can still have substantial non-correlation in the less-associated tails, 
which may then lead to mismatches. So you need to reword.-->
Such 
...
asymmetry of tail association between pairs of aphid time series or pairs of *Ceratium* 
time series at $n$. Denote by
...
<!--***DAN: Lawrence had trouble understanding from here ...-->
...
<!--...to here and asked if we could clarity. He said this same point comes up again
later and is clearer there, so maybe look how it was done there, first, then revise
here for clarity.-->
We again used
...
To show this, we show that for some locations, the matrix $C^n$ was comprised largely of positive values, 
...
<!--***DAN: Co-edited the above para on the fly with Lawrence and shya in order to make
it clear that we were intentionally saying the same things three times, as it were.
But read it though carefully and make sure you did not intro any other wording 
problems-->
...
To show this, we show that for some locations, the matrix $C^n$ was 
