...
We showed this asymmetry at species level emerged due to the similar 
...
which caused synchronous response among \textit{Ceratium spp}. Sea surface 
temperature data pre-processing was the same as used in @sheppard2017.
