...
I used left- and right-. At present the others have not been used according to a search on 2/12.
DONE-->
...
cannonical choice of which variable to take the negative of. We again used
...
<!--***DAN: this appears to have been done-->
...
<!--***DAN: Shyamolina, in the upper left corner of Fig. 2C, F_{C,R} needs to
be replaced with |F_{C,R}|. Please also make the analogous change for other figures in the 
main text and sup mat..-->
...
for the *ceeratium* and aphid data, as follows. First, we calculated 
...
For the aphid data, the statistics $A_C^n$ and $A_D^n$ were positively but non-significantly correlated
...
series will require slightly modified methods. The only negative association between species time series
...
community ecology. Our results provide evidence that an approach focusing on 
