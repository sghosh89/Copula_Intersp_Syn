--- 
title: "A new approach to interspecific synchrony in population ecology using copulas"
...
<!--***DAN: We decided to go for JAE, so need to put this abstract in JAE format:
5 bullets with 1) background, 2) goal, 3) what was done, 4) what was found, 5) what this means
in a broad context. DONE.-->
...
<!--***DAN: need to replace tail dependence with tail associations throughout. I will do this
as I edit, but you also need to do a search and replace afterwards.-->
between phenological or population-density variables of co-located species,
and their ecological importance. 

\noindent 3) We employ a simple method of measuring tail associations called the *partial Spearman correlation*.
...
very different patterns of association [@Ghosh_copula]. The variables of Fig. \ref{pedagogfig}A
...
\caption{Pedagogical figure for introducing copulas, tail association, and partial Spearman correlation.
...
and panel B shows the reverse. (C, D) Copula plots 
<!--***DAN: I suspect we are going to have to change this terminology, "Copula plot"-->
...
asymmetry of tail association (see Methods). This figure is similar in some respects to Figs 1 and 7 of Ghosh \emph{et al} (2020).}\label{pedagogfig}
\end{center}
\end{figure}
...
means if the citation ever changes, we will have to change it manually here.-->
...
<!--***DAN: Shyamolina changed the above in her last roung of edits, think carefully when you read the whole thing-->
