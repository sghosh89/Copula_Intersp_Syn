...
\textit{Ceratium spp.} along with their predator C. fin. We also considered
...
which caused synchronous response among \textit{Ceratium spp.}
...
occurrence of \textit{Ceratium}s). Similarly, locations where \textit{Ceratium spp.} were synchronously 
