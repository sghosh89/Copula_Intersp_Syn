...
zero tail-dependence in both tail, and hence considered as a symmetric copula.
...
Net productivity for an ecosystem could be constrained by some limiting factors (Leibig's law).
This limiting factor could be climatic (temperature, windspeed, salinity 
or moisture) or could be biotic (predators) which propagates through trophic levels.
...
causes such asymmetric tail dependences in inter-species copulas. 
...
We will analyze inter-species synchrony with two multi-species
...
and (Q2) if they do show such asymmetric tail-dependence then what causes such tail dependence? 
We hypothesized possible biotic and/ or abiotic drivers causes such tail-dependence in 
inter-specific synchrony.
