...
which transmitted similar asymmetric tail-dependence from drivers level ($A_S^n$ or $\alpha_S^n$)
to species level ($A_D^n$ or $\alpha_D^n$). To explain asymmetric tail-dependence between 
...
\caption{Significant Kendall correlation (based on p value $\leq 0.05$ from one tailed test for 
positive association) between $\alpha_S^n(i)$ and $\alpha_D^n(i) ; i = 1, 2, \dots 20$, for most 
of the selected sampling sites explains asymmetric tail-dependence between species-winter
average temperature was the reason for similar tail-dependence between $i^{th}$ species
