...
<!--***DAN: why 36? Seems odd as stated, ***Shya: ok, now fixed.-->
...
a copula is plotted (\nameref{Introduction}, Fig. \ref{pedagogfig}A-D). The partial Spearman correlation for the
...
plankton locations, or for additional possible reasons elaborated in the \nameref{Discussion}.
...
of our index $\cor_{0,b}(u,1-v)-\cor_{1-b,1}(u,1-v)$. Note 
that $\cor_{0,b}(u,1-v)$ conceptually should give us the same result as of 
$\cor_{0,b}(u,v^{*})$, where $(u, v^{*})$ are the normalized ranks of timeseries
of two variables $(x, -y)$ and here variable $y$ is taken reversed. Because $|\cor_{0,b}(u,1-v)-\cor_{1-b,1}(u,1-v)|=|\cor_{0,b}(1-u,v)-\cor_{1-b,1}(1-u,v)|$,
