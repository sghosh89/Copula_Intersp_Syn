...
Tail association between co-located species time series was apparently inherited from
common tail association of the species on environmental drivers. 
...
common tail association on environmental drivers. 
...
this common dependence leads to right-tail association between aphids. Thus winter temperature
...
Although our results are sufficient to show that copula structure and tail association are
...
association can still be considered for negatively correlated variables, $u,v$, 
...
copula and tail association ideas to different datasets to assess whether these ideas
...
community ecology. Our results provide evidence that a copula approach, focusing on 
associations between variables in their extremes,
