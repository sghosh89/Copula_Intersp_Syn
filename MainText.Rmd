...
the James S McDonnell Foundation.-->This study was pasrtly funded by 
US National Science Foundation grants 1714195 and 1442595 and 
the James S McDonnell Foundation.  

# Author contributions

The first, second and the corresponding author designed the study and analyzed the data, the first and 
the corresponding author wrote the manuscript, the third author provided the data and 
assisted with interpretation of results, and all authors edited the manuscript
...
Plankton data are available from the Dryad Digital Repository https://doi.org/10.5061/dryad.rq3jc84 [@Sheppard2019data]. Full code for the analyses are at "link is available from the journal office". <!--\url{https://github.com/sghosh89/Copula_Intersp_Syn}.-->
