...
(shown within blue boxes) which had atleast 30 years of firstflight data for 
...
\caption{Aphid firstflight data showed no significant relationship between total asymmetry on species level $A_S^n$ and 
