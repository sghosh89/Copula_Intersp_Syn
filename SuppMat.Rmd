...
\caption[Planktons: $C^n$ matrix plot for selected locations]{Analogous figure as of 
\ref{MT-fig_CorlmCoru_plankton_map_loc12_26}(B) and (C) showing 
$C^n$ for all selected sampling sites except for location 3 (as it had independent copulas)
...
\caption[Aphids: $C^n$ matrix plot for selected locations]{Analogous 
...
\caption{Aphid first flight data showed no significant relationship between total asymmetry on species level $A_C^n$ and 
