...
dt2<-tibble("Definition"=c("Data (population or phenological) for species $i$ in site $n$ at time $t$.",
                           "Partial Spearman correlation measuring association of two time series within two bounds, $l_b,u_b$.",
...
knitr::kable(dt, "latex", booktabs = T, linesep = "\\addlinespace",align="l", escape=F,
      caption = "Notations used in the maintext. \\label{tab_notation}")%>%column_spec(2, width = "9 cm")
